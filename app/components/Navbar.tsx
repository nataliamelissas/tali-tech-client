    ...
    <nav className={navStyle.navbar}>
      <div className={navStyle.navbarContainer}>
        ...
        <div className={isOpen ? navStyle.menuOpen : navStyle.menuClosed}>
          <Link href="/" className={navStyle.navLink}>
            Home
          </Link>
          <Link href="/pages/courses" className={navStyle.navLink}>
            Courses
          </Link>
          <Link href="/pages/schools" className={navStyle.navLink}>
            At Schools
          </Link>
          {/* meet the teachers, contact, mission/values */}
          <Link href="/pages/about" className={navStyle.navLink}>
            About Us
          </Link>
        </div>
